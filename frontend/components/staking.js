...
const getAssets = async (ids) => {
    const queriedAssets = await Promise.all(
        ids.map(async (id) => await contract.getPositionById(id))
    );
    ...
    <section className={styles.stakingContainer}>
        <section>
            <section className={styles.stakeUnstakeTab}>
                <section className={`${stakingTab ? styles.stakingType : ""}`}
                id="stake"
                ...
                {stakingTab ?(
                    <section className={styles.stakingBox}>
                        ...
                        <section className={styles.stakingInfo}>
                            <p>
                                Balance <span>{(walletBalance /10 ** 18).toLocaleString()}</span>
                            </p>
                            <p>Exchange Rate: 1.03582321</p><br></br>
                        </section>
                        <button className={styles.stakeBtn}
                    ...
                    <section className={styles.stakingBox}>
                        ...
                        <section className={styles.stakingInfo}>
                             <p>
                                Balance:
                                {assets.length > 0 && assets.map((a,id) =>{
                                    if(a.open) {
                        ...
                        <button className={styles.stakeBtn} onClick={()=>withdraw(assets[assets.length -1].positionId)}>
                            UNSTAKE
                        </button>
                    </section>
                )}
            ...
            <section className={styles.stakingInfoSection}>
                <section className={styles.stakingInfo}>
                    ...
                    <section className={styles.lockedStaking}>
                        <span>Locked 30 days</span><br></br>
                        <span className={styles.lockedStakingAPY}>8% APY</span><br></br>
                        <input
                        className={styles.inputField}
                        type="number"
                        id="inputField"
                    ...
                    <section className={styles.lockedStaking}>
                        <span>Locked 60 days</span><br></br>
                        <span className={styles.lockedStakingAPY}>9% APY</span><br></br>
                        <input
                        className={styles.inputField}
                        type="number"
                        id="inputField"
                    ...
                    <section className={styles.lockedStaking}>
                        <span>Locked 90 days</span><br></br>
                        <span className={styles.lockedStakingAPY}>12% APY</span><br></br>
                        <input
                        className={styles.inputField}
                        type="number"
                        id="inputField"
